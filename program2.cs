...
//{
   ...
   // {
        // shared one
     //   string a = "sudha"; // using literal // get stored in a string pool
     //   string e = "sudha";
     //    Console.WriteLine(object.ReferenceEquals(a, e));
        // it's not the shared one
     //   string b = new string("sudha"); //using constructor // It's treating as a new string object 
    //    string d = new string("sudha");
